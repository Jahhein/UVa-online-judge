...

{
  ...
  "%07.2f"="ex; 0001.23" "%+7.2f"="adds + sign. ex; +1.23"
  "%(6.2f"="a negative number would print (1.23)" "%,10d"="shows decimal separators."
...

{
  ...
  boolean regionMatches ( boolean ignoreCase, int tooffset, String other,int ooffset,
  int len)
